export function loadMenuPage() {
    ...
    p.textContent = "Our menu consists of food, more food, some more food, a little bit more food, and some more food!";
    p.style.width = "80%";
    ...
    menuButton.style.backgroundColor = "rgb(150, 147, 240)";
    menuButton.style.height = "2.5rem";
    menuButton.style.width = "8.5rem";
    menuButton.style.border = "2px white solid";
